...
class OrderController extends Controller
{
    ...
    public function place(Request $request)
    {
        ...
        try {
            ...
            DB::rollBack();
            return back()->with('error', 'Order failed. Please try again.')->withInput();
        }
    }

    public function whatsapp(Order $order)
    {
        $waNumber = config('app.whatsapp_number', env('WHATSAPP_NUMBER', '919994141294'));

        $message  = "🌟 *New Order from PK Photography* 🌟\n\n";
        ...
        $message .= "\n_Thank you for choosing PK Photography!_ 📷";
